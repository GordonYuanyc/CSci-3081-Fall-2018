...
+ Pass: Check that a GoogleTest test passes.
    passes the test: DateTest.SpecialDateConstructorTest.
...
+ Pass: Check that a GoogleTest test passes.
    passes the test: DateTest.Operator_Minus.



+ Pass: Check that a GoogleTest test passes.
    passes the test: DateTest.Operator_Plus.
